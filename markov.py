...
# 文章を読み込む
sjis_file = "kokoro.txt"
dict_file = "markov_kokoro.json"
if not os.path.exists(dict_file):
	...
	text = text.strip()
	text = text.replace(u'｜', '')        # ルビの開始記号を削除
	...
	# 辞書を生成
	dic = make_dic(words)
	json.dump(dic, codecs.open(dict_file, "w", encoding="utf-8"))
else:
	dic = json.load(codecs.open(dict_file, "r"))
